...
# Get workspace
config_path="aml_configconfig.json"
...
try:
    ...
    production_model_loss = production_model_run.get_metrics().get("final_loss")
    new_model_loss = new_model_run.get_metrics().get("final_loss")
    print(
        "Current Production model loss: {}, New trained model loss: {}".format(
